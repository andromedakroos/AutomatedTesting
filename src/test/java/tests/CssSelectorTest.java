...
public class CssSelectorTest {
    ...
    @Test
    public void cssSelectorLocatorsTest() {
        driver.get("C:\\Users\\andro\\IdeaProjects\\AutomatedTesting\\src\\test\\resources\\index.html");
        //Поиск по ID
        ...
        Assert.assertEquals(1, driver.findElements(By.cssSelector("[id='my-Address']")).size());
        ...
        //Поиск elementov по classname с учетом иерархии
        Assert.assertEquals(driver.findElements(By.cssSelector("#Lastname .markup")).size(), 2);

        //Poisk vseh elementov s tagname h1 ili p
        ...
        // Поиск всех элементов с атрибутом lang
        ...
        // Поиск всех элементов у которых присутствует аттрибут id со значением заканчивающимся на какое-то value(substring)
        ...
        // Поиск по свойствам, всех disabled элементов
