...
public class XpathSelectorTest {
    ...
    public void XpathSelectorLocatorsTest() {
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//*[starts-with(@id, 'ess')]")).isDisplayed());
